        ...
        child: Padding(
          ...
          child: Column(
            children: [
              Row(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(context.watch<CheckSerivce>().isCheck
                        ? "출석완료"
                        : "출석하기"),
                  )
                ],
                              ...
                              return GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  if (snapshot.data!.docs.length >
                                      index + 8 * currentPage) {
                                    var curIndex = index + 8 * currentPage;
                                    String name = snapshot.data?.docs[curIndex]
                                        .get("name");
              ...
              Expanded(child: Center(child: Text("기능2")))
            ],
          ),
        ),
      ),
